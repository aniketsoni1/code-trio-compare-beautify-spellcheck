...
const DEFS: LanguageDefinition[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "type", "struct", "interface", "map", "chan", "go", "defer", "var",
      "const", "switch", "case", "default", "break", "continue", "nil",
      "true", "false",
    ],
  },
  {
    ...
    keywords: [
      ...
      "use", "mod", "pub", "return", "if", "else", "match", "for", "while",
      "loop", "break", "continue", "where", "self", "Self", "crate", "super",
      "async", "await", "dyn", "move", "ref", "true", "false",
    ],
  },
  {
    id: "c",
    ...
    stringDelimiters: ['"', "'"],
    whitespaceSensitive: false,
    keywords: ["int", "char", "void", "return", "if", "else", "for", "while", "struct", "typedef", "const", "static", "sizeof"],
  },
  {
    id: "cpp",
    aliases: ["c++"],
    ...
    stringDelimiters: ['"', "'"],
    whitespaceSensitive: false,
    keywords: ["class", "namespace", "template", "public", "private", "protected", "virtual", "return", "if", "else", "for", "while", "const", "auto", "nullptr"],
  },
  {
    id: "java",
    aliases: [],
    ...
    stringDelimiters: ['"', "'"],
    whitespaceSensitive: false,
    keywords: ["class", "interface", "public", "private", "protected", "static", "final", "void", "return", "if", "else", "for", "while", "new", "package", "import", "extends", "implements", "null", "true", "false"],
  },
  {
    id: "scss",
    aliases: [],
